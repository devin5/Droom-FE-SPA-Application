...
import { getEmployersArray } from "../../actions/index";
...
function EmployerDisplay(props) {
    ...
    return (
      ...
      >
        ...
        <CarouselCaption
          ...
          captionText={item.coName}
          captionHeader={item.city}
        />
      </CarouselItem>
    );
  });
...
export default connect(mapStateToProps, { getEmployersArray })(EmployerDisplay);
